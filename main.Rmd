...
- Think about additional BioC package types for data & metadata: Annotation/Experiment Data(Hub), [Workflow](https://contributions.bioconductor.org/workflow-packages.html)
- Write packages that solve specific & well defined tasks and connect them in package ecosystems.
