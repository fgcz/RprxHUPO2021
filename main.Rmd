---
title: "Proteomics in R from a user and developer perspective"
...
# HUPO 2021 Reconnect Bioinformatics Hub
Thursday, November 11, 2021
11:30 – 12:00: Session #5b
...
## A case study {data-background=PictureLFQWorkflow2.png data-background-size=cover}

LFQ service workflow (includes all tasks listed before)

![](PictureLFQWorkflow2.png)

## Example R code snippet {.columns-2 .smaller .build}
